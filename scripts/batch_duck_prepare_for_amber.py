...
def main():
    ...
    parser.add_argument('-f', '--small_molecule_forcefield', type=str, default='SMIRNOFF', choice=('SMIRNOFF', 'GAFF2'), help='Small Molecules forcefield.')
    parser.add_argument('-c', '--chunk', default = None, help='Chunked protein')
    parser.add_argument('-s', '--water-model', default='tip3p', type=str.lower, choice=('TIP3P', 'TIP4PEW', 'SPCE'), help='Water model to parametrize the solvent with')
    parser.add_argument('-pf','--protein-forcefield', default='amber99sb', type=str.lower, choice = ('amber99sb', 'amber14-all'), help='Protein forcefield to parametrize the chunked protein.')
